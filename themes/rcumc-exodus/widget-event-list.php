...
<?php if( $eo_event_loop->have_posts() ): ?>
	...
	<ul <?php echo $id; ?> class="<?php echo esc_attr($classes);?>" > 
		...
		<?php while( $eo_event_loop->have_posts() ): $eo_event_loop->the_post(); ?>
			...
			<ul class="<?php echo esc_attr(implode(' ',$eo_event_classes)); ?>" margin-left="0px">
			<?php 
                        ...
                        ?>
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_title(); ?></a> <br/><?php echo eo_get_the_start($format); ?>
			</ul><br/>
